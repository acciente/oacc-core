...
public class TestSQLAccessControlContextBase {
   ...
   private static final String PROP_RSFRootPwd = "-rsfrootpass";

   protected static String dbUrl;
   protected static String dbUser;
   protected static String dbPwd;
   protected static String dbSchema;
   protected static String rsfRootPwd;
   ...
   protected static boolean checkDBConnectArgs(String[] args) {
      if (args.length < 4) {
         System.out.println("Usage: java com.acciente.rsf.sql.TestSQLAccessControlContext "
                                  + PROP_DbUrl + "=<db-url> "
                                  + PROP_DbUser + "=<db-user> "
                                  + PROP_DbPwd + "=<db-password> "
                                  + PROP_RSFRootPwd + "=<RSF-root-password> "
