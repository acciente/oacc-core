...
import com.acciente.rsf.sql.SQLAccessControlContextFactory;
...
public class TestAccessControlBase {
   ...
   public void setUpTest() throws Exception {
      SQLAccessControlSystemResetUtil.resetRSF(dataSource, Constants.DB_SCHEMA, Constants.RSF_ROOT_PWD);
   ...
   private static void authenticateSystemAccessControlContext() throws AccessControlException {
      systemAccessControlContext.authenticate(SYS_RESOURCE, Constants.RSF_ROOT_PWD);
   }

   protected void authenticateSystemResource() throws AccessControlException {
      accessControlContext.authenticate(SYS_RESOURCE, Constants.RSF_ROOT_PWD);
   }
