...
public class RSF_Grant_DomPerm_Sys extends DbBase {
   ...
   RSF_Grant_DomPerm_Sys(Builder builder) {
   ...
   public boolean equals(Object o) {
      ...
      RSF_Grant_DomPerm_Sys that = (RSF_Grant_DomPerm_Sys) o;
   ...
   public String toString() {
      return "RSF_Grant_ResDom_SysPerm{" +
   ...
   public static class Builder {
      ...
      public RSF_Grant_DomPerm_Sys build() {
         return new RSF_Grant_DomPerm_Sys(this);
      }
   }
   ...
   public static class Finder {
      ...
      public static List<RSF_Grant_DomPerm_Sys> findByAccessorIDAndAccessedID(Connection con,
                                                                                 String dbSchema,
         ...
         try (PreparedStatement preparedStatement
            ...
            List<RSF_Grant_DomPerm_Sys> result = new ArrayList<>();
      ...
      private static RSF_Grant_DomPerm_Sys getDB_Granted_Domain_SysPermission(ResultSet resultSet) throws SQLException {
