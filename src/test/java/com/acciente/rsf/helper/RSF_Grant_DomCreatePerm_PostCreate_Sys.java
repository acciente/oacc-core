...
public class RSF_Grant_DomCreatePerm_PostCreate_Sys extends DbBase {
   ...
   RSF_Grant_DomCreatePerm_PostCreate_Sys(Builder builder) {
   ...
   public boolean equals(Object o) {
      ...
      RSF_Grant_DomCreatePerm_PostCreate_Sys that = (RSF_Grant_DomCreatePerm_PostCreate_Sys) o;
   ...
   public String toString() {
      return "RSF_Grant_DomCreatePerm_PostCreate_Sys{" +
   ...
   public static class Builder {
      ...
      public RSF_Grant_DomCreatePerm_PostCreate_Sys build() {
         return new RSF_Grant_DomCreatePerm_PostCreate_Sys(this);
      }
   }
   ...
   public static class Finder {
      ...
      public static List<RSF_Grant_DomCreatePerm_PostCreate_Sys> findByAccessorID(Connection con,
                                                                       String dbSchema,
         ...
         try (PreparedStatement preparedStatement
            ...
            List<RSF_Grant_DomCreatePerm_PostCreate_Sys> result = new ArrayList<>();
      ...
      private static RSF_Grant_DomCreatePerm_PostCreate_Sys getDB_Granted_CreateDomain_SysPermission(
