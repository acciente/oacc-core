...
public class RSF_Grant_DomCreatePerm_Sys extends DbBase {
   ...
   RSF_Grant_DomCreatePerm_Sys(Builder builder) {
   ...
   public boolean equals(Object o) {
      ...
      RSF_Grant_DomCreatePerm_Sys that = (RSF_Grant_DomCreatePerm_Sys) o;
   ...
   public static class Builder {
      ...
      public RSF_Grant_DomCreatePerm_Sys build() {
         return new RSF_Grant_DomCreatePerm_Sys(this);
      }
   }
   ...
   public static class Finder {
      ...
      public static List<RSF_Grant_DomCreatePerm_Sys> findByAccessorID(Connection con,
                                                                       String dbSchema,
         ...
         try (PreparedStatement preparedStatement
            ...
            List<RSF_Grant_DomCreatePerm_Sys> result = new ArrayList<>();
      ...
      private static RSF_Grant_DomCreatePerm_Sys getDB_Granted_CreateDomain_SysPermission(
