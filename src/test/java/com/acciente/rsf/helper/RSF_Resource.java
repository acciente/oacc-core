...
public class RSF_Resource extends DbBase {
   ...
   public boolean equals(Object o) {
      ...
      RSF_Resource that = (RSF_Resource) o;
   ...
   public static class Builder {
      ...
      public RSF_Resource build() {
         return new RSF_Resource(this);
      }
   }
   ...
   public static class Finder {
      ...
      public static RSF_Resource findByID(Connection con, String dbSchema, int resourceID) throws SQLException {
         try (PreparedStatement preparedStatement
                    = con.prepareStatement("SELECT * FROM " + getQualifiedTableName(dbSchema) + " WHERE ResourceID=?");
         ) {
            RSF_Resource resource = null;
      ...
      private static RSF_Resource getDB_Resource(ResultSet resultSet) throws SQLException {
