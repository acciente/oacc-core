...
import com.acciente.rsf.sql.internal.SQLAccessControlSystemInitializer;
...
public class SQLAccessControlSystemResetUtil {
   public static void resetRSF(Connection connection, String dbSchema, String rsfRootPwd)
         throws SQLException, InterruptedException {
      deleteAllRSFData(connection, dbSchema);
      SQLAccessControlSystemInitializer.initializeRSF(connection, dbSchema, rsfRootPwd);
   }

   public static void resetRSF(DataSource dataSource, String dbSchema, String rsfRootPwd)
         throws SQLException, InterruptedException {
   ...
   public static void deleteAllRSFData(Connection connection,
                                       String dbSchema) throws SQLException, InterruptedException {
      PreparedStatement statement;

      final String schemaNameAndTablePrefix = dbSchema != null ? dbSchema + ".RSF_" : "RSF_";
