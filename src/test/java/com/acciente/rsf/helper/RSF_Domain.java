...
public class RSF_Domain extends DbBase {
   ...
   public static class Builder {
      ...
      public RSF_Domain build() {
         return new RSF_Domain(this);
      }
   }
   ...
   public static class Finder {
      ...
      private static RSF_Domain getDB_Domain(ResultSet resultSet) throws SQLException {
