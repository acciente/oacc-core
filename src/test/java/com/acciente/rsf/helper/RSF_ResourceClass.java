...
public class RSF_ResourceClass extends DbBase {
   ...
   RSF_ResourceClass(Builder builder) {
   ...
   public boolean equals(Object o) {
      ...
      RSF_ResourceClass that = (RSF_ResourceClass) o;
   ...
   public static class Builder {
      ...
      public RSF_ResourceClass build() {
         return new RSF_ResourceClass(this);
      }
   ...
   public static class Finder {
      ...
      public static RSF_ResourceClass findByID(Connection con,
                                               String dbSchema,
         ...
         try (PreparedStatement preparedStatement
            ...
            RSF_ResourceClass resourceClass = null;
      ...
      private static RSF_ResourceClass getDB_ResourceClass(ResultSet resultSet) throws SQLException {
