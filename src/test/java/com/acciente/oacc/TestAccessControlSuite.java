...
public class TestAccessControlSuite  {
   ...
   public static TestSuite suite() {
      ...
      suite.addTest(new JUnit4TestAdapter(TestAccessControl_assertDomainPermission.class));
      suite.addTest(new JUnit4TestAdapter(TestAccessControl_assertPostCreateDomainPermission.class));
      suite.addTest(new JUnit4TestAdapter(TestAccessControl_hasDomainPermission.class));
      suite.addTest(new JUnit4TestAdapter(TestAccessControl_hasResourcePermission.class));
      suite.addTest(new JUnit4TestAdapter(TestAccessControl_hasGlobalResourcePermission.class));
      suite.addTest(new JUnit4TestAdapter(TestAccessControl_hasPostCreateDomainPermission.class));
      suite.addTest(new JUnit4TestAdapter(TestAccessControl_hasPostCreateResourcePermission.class));
      suite.addTest(new JUnit4TestAdapter(TestAccessControl_hasDomainCreatePermission.class));
      suite.addTest(new JUnit4TestAdapter(TestAccessControl_assertDomainCreatePermission.class));
      suite.addTest(new JUnit4TestAdapter(TestAccessControl_hasResourceCreatePermission.class));
      suite.addTest(new JUnit4TestAdapter(TestAccessControl_assertResourceCreatePermission.class));
