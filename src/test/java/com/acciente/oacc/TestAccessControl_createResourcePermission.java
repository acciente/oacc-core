...
public class TestAccessControl_createResourcePermission extends TestAccessControlBase {
   ...
   public void createResourcePermission_validAsSystemResource() {
      ...
      assertThat(permissionNames, hasItems(ResourcePermissions.INHERIT));
      ...
      assertThat(permissionNames, hasItems(ResourcePermissions.INHERIT, permissionName1));
      ...
      assertThat(permissionNames, hasItems(ResourcePermissions.INHERIT, permissionName1, permissionName2));
   }
   ...
   public void createResourcePermission_whitespaceConsistent() {
      ...
      permissionNames = accessControlContext.getResourcePermissionNames(resourceClassNameTrimmed);
      assertThat(permissionNames.size(), is(2));
      assertThat(permissionNames, hasItems(ResourcePermissions.INHERIT, permissionNameTrimmed));
   }
   ...
   public void createResourcePermission_caseSensitiveConsistent() {
      ...
      if (isDatabaseCaseSensitive()) {
         ...
         permissionNames = accessControlContext.getResourcePermissionNames(resourceClassName_lower);
         assertThat(permissionNames.size(), is(2));
         assertThat(permissionNames, hasItems(ResourcePermissions.INHERIT, permissionName_lower));
         ...
         permissionNames = accessControlContext.getResourcePermissionNames(resourceClassName_lower);
         assertThat(permissionNames.size(), is(3));
         assertThat(permissionNames, hasItems(ResourcePermissions.INHERIT, permissionName_lower, permissionName_UPPER));
   ...
   public void createResourcePermission_duplicatePermission_shouldFail() {
      ...
      try {
         ...
         assertThat(permissionNames.size(), is(2));
         assertThat(permissionNames, hasItems(ResourcePermissions.INHERIT, permissionName));
      }
