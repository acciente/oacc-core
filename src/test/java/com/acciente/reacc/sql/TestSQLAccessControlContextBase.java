...
public class TestSQLAccessControlContextBase {
   ...
   private static final String PROP_REACCRootPwd = "-reaccrootpass";

   protected static String dbUrl;
   protected static String dbUser;
   protected static String dbPwd;
   protected static String dbSchema;
   protected static String reaccRootPwd;
   ...
   protected static boolean checkDBConnectArgs(String[] args) {
      if (args.length < 4) {
         System.out.println("Usage: java com.acciente.reacc.sql.TestSQLAccessControlContext "
                                  + PROP_DbUrl + "=<db-url> "
                                  + PROP_DbUser + "=<db-user> "
                                  + PROP_DbPwd + "=<db-password> "
                                  + PROP_REACCRootPwd + "=<REACC-root-password> "
