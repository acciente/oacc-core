...
public class REACC_ResourceClass extends DbBase {
   ...
   REACC_ResourceClass(Builder builder) {
   ...
   public boolean equals(Object o) {
      ...
      REACC_ResourceClass that = (REACC_ResourceClass) o;
   ...
   public static class Builder {
      ...
      public REACC_ResourceClass build() {
         return new REACC_ResourceClass(this);
      }
   ...
   public static class Finder {
      ...
      public static REACC_ResourceClass findByID(Connection con,
                                               String dbSchema,
         ...
         try (PreparedStatement preparedStatement
            ...
            REACC_ResourceClass resourceClass = null;
      ...
      private static REACC_ResourceClass getDB_ResourceClass(ResultSet resultSet) throws SQLException {
