...
public class REACC_Grant_ResCreatePerm extends DbBase {

   private static String getQualifiedTableName(String schemaName) {
      return getSchemaAndTableNamePrefix(schemaName) + "Grant_ResCrPerm_PostCr";
   }

   private static String getPKColumnNames() {
      return "AccessorResourceID, AccessedDomainID, ResourceClassId, PostCreatePermissionId";
   }
