...
public class REACC_Grant_DomCreatePerm_PostCreate_Sys extends DbBase {
   ...
   REACC_Grant_DomCreatePerm_PostCreate_Sys(Builder builder) {
   ...
   public boolean equals(Object o) {
      ...
      REACC_Grant_DomCreatePerm_PostCreate_Sys that = (REACC_Grant_DomCreatePerm_PostCreate_Sys) o;
   ...
   public String toString() {
      return "REACC_Grant_DomCreatePerm_PostCreate_Sys{" +
   ...
   public static class Builder {
      ...
      public REACC_Grant_DomCreatePerm_PostCreate_Sys build() {
         return new REACC_Grant_DomCreatePerm_PostCreate_Sys(this);
      }
   }
   ...
   public static class Finder {
      ...
      public static List<REACC_Grant_DomCreatePerm_PostCreate_Sys> findByAccessorID(Connection con,
                                                                       String dbSchema,
         ...
         try (PreparedStatement preparedStatement
            ...
            List<REACC_Grant_DomCreatePerm_PostCreate_Sys> result = new ArrayList<>();
      ...
      private static REACC_Grant_DomCreatePerm_PostCreate_Sys getDB_Granted_CreateDomain_SysPermission(
