...
public class REACC_Resource extends DbBase {
   ...
   REACC_Resource(Builder builder) {
   ...
   public boolean equals(Object o) {
      ...
      REACC_Resource that = (REACC_Resource) o;
   ...
   public static class Builder {
      ...
      public REACC_Resource build() {
         return new REACC_Resource(this);
      }
   }
   ...
   public static class Finder {
      ...
      public static REACC_Resource findByID(Connection con, String dbSchema, int resourceID) throws SQLException {
         try (PreparedStatement preparedStatement
                    = con.prepareStatement("SELECT * FROM " + getQualifiedTableName(dbSchema) + " WHERE ResourceID=?");
         ) {
            REACC_Resource resource = null;
      ...
      private static REACC_Resource getDB_Resource(ResultSet resultSet) throws SQLException {
