...
public class REACC_Grant_ResPerm extends DbBase {

   private static String getQualifiedTableName(String schemaName) {
      return getSchemaAndTableNamePrefix(schemaName) + "Grant_ResPerm";
   }

   private static String getPKColumnNames() {
      return "AccessorResourceID, AccessedResourceID, ResourceClassID, PermissionID";
   }
