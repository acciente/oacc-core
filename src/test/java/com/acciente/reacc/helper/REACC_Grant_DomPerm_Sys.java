...
public class REACC_Grant_DomPerm_Sys extends DbBase {
   ...
   REACC_Grant_DomPerm_Sys(Builder builder) {
   ...
   public boolean equals(Object o) {
      ...
      REACC_Grant_DomPerm_Sys that = (REACC_Grant_DomPerm_Sys) o;
   ...
   public String toString() {
      return "REACC_Grant_DomPerm_Sys{" +
   ...
   public static class Builder {
      ...
      public REACC_Grant_DomPerm_Sys build() {
         return new REACC_Grant_DomPerm_Sys(this);
      }
   }
   ...
   public static class Finder {
      ...
      public static List<REACC_Grant_DomPerm_Sys> findByAccessorIDAndAccessedID(Connection con,
                                                                                 String dbSchema,
         ...
         try (PreparedStatement preparedStatement
            ...
            List<REACC_Grant_DomPerm_Sys> result = new ArrayList<>();
      ...
      private static REACC_Grant_DomPerm_Sys getDB_Granted_Domain_SysPermission(ResultSet resultSet) throws SQLException {
