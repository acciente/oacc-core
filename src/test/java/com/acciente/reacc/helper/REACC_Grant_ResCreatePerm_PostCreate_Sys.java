...
public class REACC_Grant_ResCreatePerm_PostCreate_Sys extends DbBase {

   private static String getQualifiedTableName(String schemaName) {
      return getSchemaAndTableNamePrefix(schemaName) + "Grant_ResCrPerm_PostCr_Sys";
   }

   private static String getPKColumnNames() {
      return "AccessorResourceID, AccessedDomainID, ResourceClassId, PostCreateSysPermissionId";
   }
