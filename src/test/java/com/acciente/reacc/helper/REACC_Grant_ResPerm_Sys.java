...
public class REACC_Grant_ResPerm_Sys extends DbBase {

   private static String getQualifiedTableName(String schemaName) {
      return getSchemaAndTableNamePrefix(schemaName) + "Grant_ResPerm_Sys";
   }

   private static String getPKColumnNames() {
      return "AccessorResourceID, AccessedResourceID, ResourceClassID, SysPermissionID";
   }
