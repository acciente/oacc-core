...
public class REACC_Grant_DomCreatePerm_Sys extends DbBase {
   ...
   REACC_Grant_DomCreatePerm_Sys(Builder builder) {
   ...
   public boolean equals(Object o) {
      ...
      REACC_Grant_DomCreatePerm_Sys that = (REACC_Grant_DomCreatePerm_Sys) o;
   ...
   public static class Builder {
      ...
      public REACC_Grant_DomCreatePerm_Sys build() {
         return new REACC_Grant_DomCreatePerm_Sys(this);
      }
   }
   ...
   public static class Finder {
      ...
      public static List<REACC_Grant_DomCreatePerm_Sys> findByAccessorID(Connection con,
                                                                       String dbSchema,
         ...
         try (PreparedStatement preparedStatement
            ...
            List<REACC_Grant_DomCreatePerm_Sys> result = new ArrayList<>();
      ...
      private static REACC_Grant_DomCreatePerm_Sys getDB_Granted_CreateDomain_SysPermission(
