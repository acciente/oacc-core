...
public class REACC_ResourceClassPermission extends DbBase {

   private static String getQualifiedTableName(String schemaName) {
      return getSchemaAndTableNamePrefix(schemaName) + "ResourceClassPermission";
   }

   private static String getPKColumnNames() {
      return "ResourceClassID, PermissionID";
   }
