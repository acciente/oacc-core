...
public class REACC_Grant_Global_ResPerm extends DbBase {

   private static String getQualifiedTableName(String schemaName) {
      return getSchemaAndTableNamePrefix(schemaName) + "Grant_Global_ResPerm";
   }

   private static String getPKColumnNames() {
      return "AccessorResourceID, AccessedDomainID, ResourceClassID, PermissionId";
   }
