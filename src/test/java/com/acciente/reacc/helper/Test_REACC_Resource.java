...
import com.acciente.reacc.sql.internal.PasswordUtils;
...
public class Test_REACC_Resource {
   ...
   public void meta_equalityOfResourcesWithEncryptedPasswords() {
      ...
      final REACC_Resource resource_01 = new REACC_Resource.Builder(0L).resourceClassID(0L).domainID(0L).password(digest_01).build();
      final REACC_Resource resource_01_plain = new REACC_Resource.Builder(0L).resourceClassID(0L).domainID(0L).password_plaintext(plaintext).build();
      final REACC_Resource resource_02 = new REACC_Resource.Builder(0L).resourceClassID(0L).domainID(0L).password(digest_02).build();
      final REACC_Resource resource_02_plain = new REACC_Resource.Builder(0L).resourceClassID(0L).domainID(0L).password_plaintext(plaintext).build();
