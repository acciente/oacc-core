...
public class REACC_Domain extends DbBase {
   ...
   public boolean equals(Object o) {
      ...
      REACC_Domain that = (REACC_Domain) o;
   ...
   public static class Builder {
      ...
      public REACC_Domain build() {
         return new REACC_Domain(this);
      }
   }
   ...
   public static class Finder {
      ...
      private static REACC_Domain getDB_Domain(ResultSet resultSet) throws SQLException {
