...
public class NonRecursiveGrantDomainPermissionSysPersister extends CommonGrantDomainPermissionSysPersister {
   public NonRecursiveGrantDomainPermissionSysPersister(SQLStrings sqlStrings) {
      super(sqlStrings);
   }
