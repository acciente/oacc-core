...
public class NonRecursiveGrantDomainCreatePermissionSysPersister extends CommonGrantDomainCreatePermissionSysPersister {
   public NonRecursiveGrantDomainCreatePermissionSysPersister(SQLStrings sqlStrings) {
      super(sqlStrings);
   }
