...
public class SQLAccessControlContext implements AccessControlContext, Serializable {
   ...
   public boolean hasDomainPermissions(Resource accessorResource,
      ...
      try {
         ...
         return __hasDomainPermission(connection, accessorResource, domainName, requestedDomainPermissions);
      }
      finally {
         __closeConnection(connection);
      }
   ...
   public boolean hasDomainCreatePermissions(Resource accessorResource,
      ...
      try {
         ...
         return __hasDomainCreatePermission(connection, accessorResource, requestedDomainCreatePermissions);
      }
      finally {
         __closeConnection(connection);
      }
   ...
   public boolean hasResourcePermissions(Resource accessorResource,
      ...
      try {
         ...
         return __hasResourcePermission(connection, accessorResource, accessedResource, requestedResourcePermissions);
      }
      finally {
         __closeConnection(connection);
      }
   ...
   public void assertResourceCreatePermissions(Resource accessorResource,
      ...
      assertResourceCreatePermissions(accessorResource, resourceClassName, sessionResourceDomainName, resourceCreatePermissions);
   }

   @Override
   public void assertResourceCreatePermissions(String resourceClassName,
                                               ResourceCreatePermission... resourceCreatePermissions) {
      assertResourceCreatePermissions(sessionResource, resourceClassName, sessionResourceDomainName, resourceCreatePermissions);
   }
   ...
   public void assertResourceCreatePermissions(String resourceClassName,
                                               String domainName,
                                               ResourceCreatePermission... resourceCreatePermissions) {
      assertResourceCreatePermissions(sessionResource, resourceClassName, domainName, resourceCreatePermissions);
   }
   ...
   public boolean hasResourceCreatePermissions(Resource accessorResource,
      ...
      try {
         ...
         return __hasResourceCreatePermission(connection,
                                              accessorResource,
                                              resourceClassName,
                                              domainName,
                                              requestedResourceCreatePermissions);
   ...
   private boolean __hasResourceCreatePermission(SQLConnection connection,
                                                 Resource accessorResource,
                                                 String resourceClassName,
                                                 String domainName,
                                                 Set<ResourceCreatePermission> requestedResourceCreatePermissions) {
