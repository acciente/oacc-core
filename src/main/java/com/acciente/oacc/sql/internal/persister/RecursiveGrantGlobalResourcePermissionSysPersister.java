...
public class RecursiveGrantGlobalResourcePermissionSysPersister extends CommonGrantGlobalResourcePermissionSysPersister {
   public RecursiveGrantGlobalResourcePermissionSysPersister(SQLStrings sqlStrings) {
      super(sqlStrings);
   }
