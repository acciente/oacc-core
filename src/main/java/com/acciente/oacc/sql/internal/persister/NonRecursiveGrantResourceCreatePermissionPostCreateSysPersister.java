...
public class NonRecursiveGrantResourceCreatePermissionPostCreateSysPersister extends CommonGrantResourceCreatePermissionPostCreateSysPersister {
   public NonRecursiveGrantResourceCreatePermissionPostCreateSysPersister(SQLStrings sqlStrings) {
      super(sqlStrings);
   }
   ...
   @Override
   public Map<String, Map<String, Set<ResourceCreatePermission>>> getResourceCreatePostCreateSysPermissionsIncludeInherited(SQLConnection connection,
                                                                                                                            Resource accessorResource) {
      SQLStatement statement = null;
