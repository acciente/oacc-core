...
public class RecursiveGrantResourceCreatePermissionSysPersister extends CommonGrantResourceCreatePermissionSysPersister {
   public RecursiveGrantResourceCreatePermissionSysPersister(SQLProfile sqlProfile,
   ...
   public Set<ResourceCreatePermission> getResourceCreateSysPermissionsIncludeInherited(SQLConnection connection,
      ...
      try {
         ...
         statement = connection.prepareStatement(sqlStrings.SQL_findInGrantResourceCreatePermissionSys_SysPermissionId_IsWithGrant_BY_AccessorID_AccessedDomainID_ResourceClassID);
   ...
   public Map<String, Map<String, Set<ResourceCreatePermission>>> getResourceCreateSysPermissionsIncludeInherited(
      ...
      try {
         ...
         statement = connection.prepareStatement(sqlStrings.SQL_findInGrantResourceCreatePermissionSys_ResourceDomainName_ResourceClassName_SysPermissionId_IsWithGrant_BY_AccessorID);
         statement.setResourceId(1, accessorResource);
         resultSet = statement.executeQuery();
   ...
   public void removeAllResourceCreateSysPermissions(SQLConnection connection,
      ...
      try {
         ...
         if (sqlProfile.isRecursiveDeleteEnabled()) {
            ...
            statement = connection.prepareStatement(sqlStrings.SQL_removeInGrantResourceCreatePermissionSys_withDescendants_BY_AccessedDomainId);

            // revoke any existing create system permissions any accessor has to this domain + any resource class
