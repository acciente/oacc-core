...
public class AccessControlContextProxy implements AccessControlContext {
   ...
   public void assertPostCreateResourcePermissions(String resourceClassName,
                                                   Set<ResourcePermission> resourcePermissions) {
      accessControlContext.assertPostCreateResourcePermissions(resourceClassName, resourcePermissions);
   }
   ...
   public void assertPostCreateResourcePermissions(String resourceClassName,
                                                   String domainName,
                                                   Set<ResourcePermission> resourcePermissions) {
      accessControlContext.assertPostCreateResourcePermissions(resourceClassName, domainName, resourcePermissions);
   }
   ...
   public boolean hasPostCreateResourcePermissions(String resourceClassName,
                                                   Set<ResourcePermission> resourcePermissions) {
      return accessControlContext.hasPostCreateResourcePermissions(resourceClassName, resourcePermissions);
   }
   ...
   public boolean hasPostCreateResourcePermissions(String resourceClassName,
                                                   String domainName,
                                                   Set<ResourcePermission> resourcePermissions) {
      return accessControlContext.hasPostCreateResourcePermissions(resourceClassName, domainName, resourcePermissions);
   }
   ...
   public Set<Resource> getResourcesByResourcePermissions(Resource accessorResource,
                                                          String resourceClassName,
                                                          Set<ResourcePermission> resourcePermissions) {
      return accessControlContext.getResourcesByResourcePermissions(accessorResource, resourceClassName, resourcePermissions);
   }
   ...
   public Set<Resource> getResourcesByResourcePermissionsAndDomain(String resourceClassName,
                                                                   String domainName,
                                                                   Set<ResourcePermission> resourcePermissions) {
      return accessControlContext.getResourcesByResourcePermissionsAndDomain(resourceClassName, domainName, resourcePermissions);
   }

   @Override
   public Set<Resource> getResourcesByResourcePermissionsAndDomain(String resourceClassName,
                                                                   Set<ResourcePermission> resourcePermissions) {
      return accessControlContext.getResourcesByResourcePermissionsAndDomain(resourceClassName, resourcePermissions);
   }
   ...
   public Set<Resource> getResourcesByResourcePermissionsAndDomain(Resource accessorResource,
                                                                   ...
                                                                   String domainName,
                                                                   Set<ResourcePermission> resourcePermissions) {
      return accessControlContext.getResourcesByResourcePermissionsAndDomain(accessorResource, resourceClassName, domainName, resourcePermissions);
   }
   ...
   public Set<Resource> getResourcesByResourcePermissionsAndDomain(Resource accessorResource,
                                                                   String resourceClassName,
                                                                   Set<ResourcePermission> resourcePermissions) {
      return accessControlContext.getResourcesByResourcePermissionsAndDomain(accessorResource, resourceClassName, resourcePermissions);
   }
   ...
   public Set<Resource> getResourcesByResourcePermissionsAndDomain(String resourceClassName,
                                                                   ResourcePermission resourcePermission,
                                                                   ResourcePermission... resourcePermissions) {
      return accessControlContext.getResourcesByResourcePermissionsAndDomain(resourceClassName, resourcePermission);
   }
   ...
   public Set<Resource> getResourcesByResourcePermissionsAndDomain(Resource accessorResource,
                                                                   ...
                                                                   ResourcePermission resourcePermission,
                                                                   ResourcePermission... resourcePermissions) {
      return accessControlContext.getResourcesByResourcePermissionsAndDomain(accessorResource, resourceClassName, resourcePermission, resourcePermissions);
   }
   ...
   public void grantDomainCreatePermissions(Resource accessorResource,
                                            Set<DomainCreatePermission> domainCreatePermissions) {
      accessControlContext.grantDomainCreatePermissions(accessorResource, domainCreatePermissions);
   }
   ...
   public void grantDomainPermissions(Resource accessorResource,
                                      String domainName,
                                      Set<DomainPermission> domainPermissions) {
      accessControlContext.grantDomainPermissions(accessorResource, domainName, domainPermissions);
   }
   ...
   public void grantDomainPermissions(Resource accessorResource,
                                      Set<DomainPermission> domainPermissions) {
      accessControlContext.grantDomainPermissions(accessorResource, domainPermissions);
   }
   ...
   public void grantDomainPermissions(Resource accessorResource,
                                      DomainPermission domainPermission,
                                      DomainPermission... domainPermissions) {
      accessControlContext.grantDomainPermissions(accessorResource, domainPermission, domainPermissions);
   }
   ...
   public void revokeDomainPermissions(Resource accessorResource,
                                       String domainName,
                                       Set<DomainPermission> domainPermissions) {
      accessControlContext.revokeDomainPermissions(accessorResource, domainName, domainPermissions);
   }
   ...
   @Override
   public Set<DomainPermission> getEffectiveDomainPermissions(Resource accessorResource) {
      return accessControlContext.getEffectiveDomainPermissions(accessorResource);
   }
   ...
   public void grantResourceCreatePermissions(Resource accessorResource,
                                              ...
                                              String domainName,
                                              Set<ResourceCreatePermission> resourceCreatePermissions) {
      accessControlContext.grantResourceCreatePermissions(accessorResource, resourceClassName, domainName, resourceCreatePermissions);
   }
   ...
   public void grantResourceCreatePermissions(Resource accessorResource,
                                              String resourceClassName,
                                              Set<ResourceCreatePermission> resourceCreatePermissions) {
      accessControlContext.grantResourceCreatePermissions(accessorResource, resourceClassName, resourceCreatePermissions);
   }
   ...
   public void grantResourcePermissions(Resource accessorResource,
                                        Resource accessedResource,
                                        Set<ResourcePermission> resourcePermissions) {
      accessControlContext.grantResourcePermissions(accessorResource, accessedResource, resourcePermissions);
   }
   ...
   public void revokeResourcePermissions(Resource accessorResource,
                                         Resource accessedResource,
                                         Set<ResourcePermission> resourcePermissions) {
      accessControlContext.revokeResourcePermissions(accessorResource, accessedResource, resourcePermissions);
   }
   ...
   public void revokeGlobalResourcePermissions(Resource accessorResource,
                                               ...
                                               String domainName,
                                               Set<ResourcePermission> resourcePermissions) {
      accessControlContext.revokeGlobalResourcePermissions(accessorResource, resourceClassName, domainName, resourcePermissions);
   }
   ...
   public void revokeGlobalResourcePermissions(Resource accessorResource,
                                               String resourceClassName,
                                               Set<ResourcePermission> resourcePermissions) {
      accessControlContext.revokeGlobalResourcePermissions(accessorResource, resourceClassName, resourcePermissions);
   }
