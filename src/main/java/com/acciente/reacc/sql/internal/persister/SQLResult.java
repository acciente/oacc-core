 ...
 */
package com.acciente.reacc.sql.internal.persister;
...
public class SQLResult {
   ...
   public String getResourceCreateSysPermissionName(String columnLabel) throws SQLException {
      return ResourceCreatePermission.getSysPermissionName(resultSet.getLong(columnLabel));
   }
   ...
   public String getDomainCreateSysPermissionName(String columnLabel) throws SQLException {
      return DomainCreatePermission.getSysPermissionName(resultSet.getLong(columnLabel));
   }

   public String getDomainSysPermissionName(String columnLabel) throws SQLException {
      return DomainPermission.getSysPermissionName(resultSet.getLong(columnLabel));
   }
