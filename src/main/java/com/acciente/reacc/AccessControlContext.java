...
/**
 * The interface with which to define and control access to REACC resources.
 * <p/>
 * An instance of this session is used to both define the REACC resources and the security privileges to them,
...
public interface AccessControlContext {
    ...
    * @param authenticationProvider a callback that allows REACC to hook into the alternate authentication mechanism
