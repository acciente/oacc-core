...
public class SQLAccessControlSystemInitializer {
   public static void initializeRSF(Connection connection,
      ...
      if (resultSet.next()) {
         System.out.println("Cannot initialize, likely that this RSF is already initialized! (check: found a system domain)");
         resultSet.close();
         return;
      }
      ...
      final String boundPassword = PasswordUtils.computeBoundPassword(0, rsfRootPwd);
